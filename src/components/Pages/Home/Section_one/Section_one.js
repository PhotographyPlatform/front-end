                    ...
                    <Box className='Section_one-cards'>
                         ...
                         <Box className='Section_one-card'>
                              <Fade duration={1000} direction='top' triggerOnce>
                                   ...
                                   <Text as={'p'}>Market yourself as a professional photographer. Show that you’re available for hire on your Profile and get discovered in Search results, showcase your presents, and more with Resources, and create a Profile website to showcase your work.</Text>
                              </Fade>
                         </Box>
                         <Box className='Section_one-card'>
                              <Fade duration={1000} direction='top' triggerOnce>
                         ...
                         <Box className='Section_one-card'>
                              <Fade duration={1000} direction='top' triggerOnce>
                                   ...
                                   <Text as={'p'}>Earn one of the highest royalty rates in the industry when you distribute your photography through Pexel Time to a global marketplace, where buyers can view and purchase your work for commercial usage.</Text>
                              </Fade>
                         </Box>
                    </Box>
               </Box>
